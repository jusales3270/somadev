...
export default function NeuralBackground({
    className,
    color = "#FB923C", // SomaDev Orange (approximate tailwind orange-400/500 match to branding)
    trailOpacity = 0.15,
    particleCount = 600,
    speed = 1,
    ...
    return (
        <div ref={containerRef} className={cn("fixed inset-0 z-[-1] bg-background overflow-hidden pointer-events-none", className)}>
